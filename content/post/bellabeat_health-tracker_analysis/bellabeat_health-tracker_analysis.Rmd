...
tags: ["E.D.A",  "Unguided Project", "Un-supervised learning", "Cluster Analysis", "Data Mining"]
output:
  blogdown::html_page:
    toc: true
    toc_depth: 4
images: []
summary: "Within this case study we are going to dive into wearable-tech health monitoring data.  We are to derive key insights from our data and perform customer segmentation to group the customers with respect to their user data behavior for targeted marketing strategies "
editor_options: 
  markdown: 
    wrap: 80
---
