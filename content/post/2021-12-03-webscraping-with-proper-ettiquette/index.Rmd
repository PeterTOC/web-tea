...
2.  **Throttle your requests**
    ...
    ```{r}
# IDEA show code sample
# FIXME or remove completely
    ```
...
<!-- CHANGED should include tips&tricks and link to scraping code --> 
...
<details>
<summary>Click for Code</summary>
```{r extraction,eval=FALSE,warning=FALSE,message=FALSE}
