...
kable(confirmed_cases_worldwide, 
      col.names = c("Date","Cummulative Confirmed Cases"),
      align = "cc")
```
...
```{r confirmed cases, fig.dim =c(3,3), fig.cap = 'Figure 1.1 confirmed cases throughout the world'}
...
```{r china vs world, out.width='50%', fig.align='right'}
