---
title: "COVID-19 Outbreak Analysis"
...
tags: ["DataViz", "Guided project", "E.D.A"]
output:
  blogdown::html_page:
    toc: true
    toc_depth: 2
...
knitr::opts_chunk$set(echo = FALSE, fig.align = 'center', collapse = TRUE, tidy = 'styler')
```
...
<img src="https://www.nps.gov/aboutus/news/images/CDC-coronavirus-image-23311-for-web.jpg?maxwidth=650&amp;autorotate=false" style="float: left; margin:5px 20px 5px 1px; width:40%"/>
...
<div class="toggle"><button>Code</button>
...
confirmed_cases_worldwide <- read_csv("~/Portfolio/web-tea/content/post/2021-09-18-covid-outbreak-analysis2-rmd/datasets/confirmed_cases_worldwide.csv")
datatable(confirmed_cases_worldwide)
```
</div>
...
<div class="toggle"><button>Code</button>
```{r confirmed cases,message=FALSE}
...
```{r china vs world,message=FALSE}
...
```{r significant events,message=FALSE}
who_events <- tribble(
  ~ date, ~ event,
...
top_countries_by_total_cases <- confirmed_cases_by_country %>%
  ...
  top_n(10)
# See the result
datatable(top_countries_by_total_cases)
```
